...
export const EffectsIcon = ({ width = '2.2rem', height = '2.2rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
    ...
    >
        ...
        <defs>
            ...
            >
                ...
                <stop offset={1} stopColor="#FF00E5" stopOpacity={0} />
            </radialGradient>
            <radialGradient
            ...
            <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
            >
                <stop stopColor="#FF698D" stopOpacity="0.806" />
                <stop offset="0.318" stopColor="#926BFF" />
                <stop offset="0.538" stopColor="#294FFF" stopOpacity="0.85" />
                <stop offset="0.807" stopColor="#0075FF" />
